...
import { AiOutlineCalendar, AiOutlineFileSearch } from "react-icons/ai";
...
const chapterGridImage = (props) => (
  <div className="image">
    <iframe
      className="w-full h-full object-contain"
      src={props.ChapterPdf || avatar2}
      title={props.ChapterId}
      width="300"
      height="100"
      alt="الدرس"
    ></iframe>
...
export const chaptersGrid = [
  ...
  {
    field: "ChapterName",
    headerText: "اسم الدرس",
    width: "150",
    textAlign: "Center",
  },
  {
    field: "ChapterDesc",
    headerText: "وصف الدرس",
    width: "170",
    textAlign: "Center",
  },
  {
    field: "ChapterSubject",
    headerText: "مادة الدرس",
    width: "150",
    textAlign: "Center",
    editType: "dropdownedit",
  },
  {
    field: "ChapterSemester",
    headerText: "فصل الدرس",
    width: "150",
    textAlign: "Center",
    editType: "dropdownedit",
  },
...
export const subjectsGrid = [
  ...
  {
    field: "SubjectDesc",
    headerText: "وصف المادة",
    width: "170",
    textAlign: "Center",
  },
  {
    field: "SubjectSemester",
    headerText: "فصل المادة",
    width: "150",
    textAlign: "Center",
    editType: "dropdownedit",
  },
...
export const levelsGrid = [
  ...
  {
    field: "LevelName",
    headerText: "اسم المرحلة",
    width: "150",
    textAlign: "Center",
  },
  {
    field: "LevelDesc",
    headerText: "وصف المرحلة",
    width: "170",
    textAlign: "Center",
  },
  {
...
export const chaptersData = [
  {
    ChapterID: 1001,
    ChapterName: "المجموعات",
    ChapterDesc: "المجموعات",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الرياضيات",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
    ChapterLevel: "المرحلة الإعدادية",
  },
  {
    ChapterID: 1002,
    ChapterName: "الجهاز الدوري",
    ChapterDesc: "الجهاز الدوري",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "العلوم",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
    ChapterLevel: "المرحلة الإعدادية",
  },
  {
    ChapterID: 1003,
    ChapterName: "المواد الغير عضوية",
    ChapterDesc: "تفاعل المواد الغير عضوية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الكيمياء",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
    ChapterLevel: "المرحلة الإعدادية",
  },
  {
    ChapterID: 1004,
    ChapterName: "البلازما",
    ChapterDesc: "خواص البلازما",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الفيزياء",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
    ChapterLevel: "المرحلة الإعدادية",
  },
  ...
  {
    ChapterID: 1006,
    ChapterName: "الدولة الفاطمية",
    ChapterDesc: "الدولة الفاطمية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "التاريخ",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
    ChapterLevel: "المرحلة الإعدادية",
  },
  {
    ChapterID: 1007,
    ChapterName: "الحج",
    ChapterDesc: "احكام الحج",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "التربية الإسلامية",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
    ChapterLevel: "المرحلة الإعدادية",
  },
  {
    ChapterID: 1008,
    ChapterName: "كرة السلة",
    ChapterDesc: "كرة السلة",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "التربية الرياضية",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
    ChapterLevel: "المرحلة الإعدادية",
  },
  {
    ChapterID: 1009,
    ChapterName: "الكسور",
    ChapterDesc: "عمليات على الكسور",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الرياضيات",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
    ChapterLevel: "المرحلة الإعدادية",
  },
  {
    ChapterID: 1010,
    ChapterName: "الجهاز البولي",
    ChapterDesc: "الجهاز البولي",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "العلوم",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1011,
    ChapterName: "المواد العضوية",
    ChapterDesc: "خواص المواد العضوية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الكيمياء",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1012,
    ChapterName: "المادة الغازية",
    ChapterDesc: "خواص المواد الغازية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الفيزياء",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1014,
    ChapterName: "الدولة العباسية",
    ChapterDesc: "تأسيس الدولة العباسية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "التاريخ",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1016,
    ChapterName: "كرة القدم",
    ChapterDesc: "كرة القدم",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "التربية الرياضية",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  },
  {
    ...
    ChapterDesc: "عمليات على الأعداد الطبيعية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الرياضيات",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1018,
    ChapterName: "الجهاز التنفسي",
    ChapterDesc: "الجهاز التنفسي",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "العلوم",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1019,
    ChapterName: "الكيمياء العضوية",
    ChapterDesc: "تفاعل المواد العضوية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الكيمياء",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1020,
    ChapterName: "المادة السائلة",
    ChapterDesc: "خواص المادة السائلة",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الفيزياء",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
  ...
  },
  {
    ChapterID: 1022,
    ChapterName: "الدولة العباسية",
    ChapterDesc: "انتهاء الدولة العباسية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "التاريخ",
    ChapterSemester: "الفصل الدراسي الأول",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1025,
    ChapterName: "الأعداد العشرية",
    ChapterDesc: "جمع وطرح الأعداد العشرية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الرياضيات",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1026,
    ChapterName: "الجهاز الهضمي",
    ChapterDesc: "الجهاز الهضمي في الانسان",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "العلوم",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1027,
    ChapterName: "الجزيئات",
    ChapterDesc: "جزيئات المادة",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الكيمياء",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1028,
    ChapterName: "المادة الصلبة",
    ChapterDesc: "خواص المادة الصلبة",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "الفيزياء",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1030,
    ChapterName: "الدولة الاموية",
    ChapterDesc: "عصر الدولة الأموية",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "التاريخ",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
  ...
  {
    ChapterID: 1032,
    ChapterName: "تدريب السباحة",
    ChapterDesc: "تدريب السباحة",
    ChapterPdf: "https://www.africau.edu/images/default/sample.pdf",
    ChapterSubject: "التربية الرياضية",
    ChapterSemester: "الفصل الدراسي الثاني",
    ChapterGrade: "الصف الأول",
...
export const subjectsData = [
  {
    ...
    SubjectDesc: "مادة الرياضيات",
    SubjectSemester: "الفصل الدراسي الأول",
    SubjectGrade: "الصف الأول",
    SubjectLevel: "المرحلة الإعدادية",
    NumberOfChapters: "40",
  },
  {
    SubjectID: 1002,
    SubjectName: "العلوم",
    SubjectDesc: "مادة العلوم",
    SubjectSemester: "الفصل الدراسي الأول",
    SubjectGrade: "الصف الأول",
    SubjectLevel: "المرحلة الإعدادية",
    NumberOfChapters: "22",
  ...
  },
  {
    ...
    SubjectDesc: "مادة التربية الإسلامية",
    SubjectSemester: "الفصل الدراسي الأول",
    SubjectGrade: "الصف الأول",
    SubjectLevel: "المرحلة الإعدادية",
    NumberOfChapters: "11",
  },
  {
    ...
    SubjectDesc: "مادة التربية الرياضية",
    SubjectSemester: "الفصل الدراسي الأول",
    SubjectGrade: "الصف الأول",
    SubjectLevel: "المرحلة الإعدادية",
    NumberOfChapters: "2",
  },
  {
    ...
    SubjectName: "الرياضيات",
    SubjectDesc: "مادة الرياضيات",
    SubjectSemester: "الفصل الدراسي الثاني",
    SubjectGrade: "الصف الأول",
    SubjectLevel: "المرحلة الإعدادية",
    NumberOfChapters: "40",
  },
...
export const semestersData = [
  {
    ...
    SemesterDesc: "الفصل الدراسي الأول",
    SemesterGrade: "الصف الأول",
    SemesterLevel: "المرحلة الإعدادية",
    NumberOfSubjects: "8",
  },
  {
    SemesterID: 1002,
    SemesterName: "الفصل الدراسي الثاني",
    SemesterDesc: "الفصل الدراسي الثاني",
    SemesterGrade: "الصف الأول",
    SemesterLevel: "المرحلة الإعدادية",
    NumberOfSubjects: "8",
  },
  ...
  },
  {
    ...
    SemesterDesc: "الفصل الدراسي الأول",
    SemesterGrade: "الصف الأول",
    SemesterLevel: "المرحلة الثانوية",
    NumberOfSubjects: "8",
  },
  {
    SemesterID: 1008,
...
export const gradesData = [
  {
    ...
    GradeDesc: "الصف الأول",
    GradeLevel: "المرحلة الإبتدائية",
    NumberOfSemesters: "3",
  },
  {
    GradeID: 1002,
    GradeName: "الصف الثاني",
    GradeDesc: "الصف الثاني",
    GradeLevel: "المرحلة الإبتدائية",
    NumberOfSemesters: "3",
  },
  {
...
export const levelsData = [
  {
    LevelID: 1001,
    LevelName: "المرحلة الإبتدائية",
    LevelDesc: "المرحلة الإبتدائية",
    NumberOfGrades: "6",
  },
  {
    LevelID: 1002,
    LevelName: "المرحلة الإعدادية",
    LevelDesc: "المرحلة الإعدادية",
    NumberOfGrades: "3",
  },
  {
    LevelID: 1003,
    LevelName: "المرحلة الثانوية",
    LevelDesc: "المرحلة الثانوية",
    NumberOfGrades: "3",
  },
];
